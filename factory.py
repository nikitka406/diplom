...
penalty = 100  # штраф за превышения временного срока

param_start_solution = 5  # параметр который будет показывать, сколько раз будем переставлять
# клиента для стартового решения
param_population = 10  # параметр который будет показывать, кол-во особей в популяции
...
param_local_search = 5  # параметр для локального поиска, сколько раз будем переставлять клиента
