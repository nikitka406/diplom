...
param_population = int(2)  # параметр который будет показывать, кол-во особей в популяции
...
coinsCheckSol = [0, 1]
param_local_search = int(3)  # сколько раз будем запускать локальный поиск
