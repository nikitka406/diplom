...
v = 50  # скорость ТС
car_cost = 100000  # цена за арнеду машины
...
param_min_num_cl_in_car = 5  # параметр отвечающий за, сколько минимально клиентов может присутствовать в однрой машине
param_crossing = param_population * 5  # сколько раз будем скрещивать решения
