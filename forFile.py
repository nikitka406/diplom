...
def ClearAllFile():
    ...
    file.close()
    file = open('log/exchlog1.txt', 'w')
    file.close()
    file = open('log/exchlog2.txt', 'w')
    file.close()
    file = open("log/genalog.txt", 'w')
    file.close()
    file = open('log/helog.txt', 'w')
    file.close()
    file = open('log/helog1.txt', 'w')
    file.close()
    file = open('log/helog2.txt', 'w')
    file.close()
    file = open('log/relog.txt', 'w')
    file.close()
    file = open('log/relog1.txt', 'w')
    file.close()
    file = open('log/relog2.txt', 'w')
    file.close()
    file = open('log/Two_Opt.txt', 'w')
    file.close()
    file = open('log/twooptlog.txt', 'w')
    file.close()
    file = open('log/twooptlog1.txt', 'w')
    file.close()
    file = open('log/twooptlog2.txt', 'w')
    file.close()
    file = open('log/hgrexlog.txt', 'w')
    file.close()
    file = open('log/hgrexlog1.txt', 'w')
    file.close()
    file = open('log/hgrexlog2.txt', 'w')
    file.close()
    file = open('log/hproxlog.txt', 'w')
    file.close()
    file = open('log/hproxlog1.txt', 'w')
    file.close()
    file = open('log/hproxlog2.txt', 'w')
    file.close()
    file = open('log/hrndxlog.txt', 'w')
    file.close()
    file = open('log/hrndxlog1.txt', 'w')
    file.close()
    file = open('log/hrndxlog2.txt', 'w')
    file.close()
